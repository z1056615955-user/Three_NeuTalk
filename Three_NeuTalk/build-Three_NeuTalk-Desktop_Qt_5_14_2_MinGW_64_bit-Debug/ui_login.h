...
public:
    ...
    void setupUi(QWidget *Login)
    {
        ...
        btn_regist->setGeometry(QRect(320, 190, 91, 23));
        QFont font;
        font.setPointSize(9);
        ...
        lineEdit_passwd->setGeometry(QRect(130, 227, 201, 26));
        ...
        cBox_account->setGeometry(QRect(130, 190, 201, 29));
        ...
        label_top_img->setStyleSheet(QString::fromUtf8("background-image: url(:/images/top_img4.png);"));
        ...
        label_user_img->setStyleSheet(QString::fromUtf8("background-image: url(:/images/top_img1.png);"));
        label_user_img->setGeometry(QRect(30, 195, 80, 80));
        btn_login = new QPushButton(Login);
        btn_login->setObjectName(QString::fromUtf8("btn_login"));
        btn_login->setGeometry(QRect(170, 290, 111, 31));
    ...
    {
        Login->setWindowTitle(QCoreApplication::translate("Login", "NeuTalk", nullptr));
